...
function drawRow(rowData) {
	...
	var tr = $("<tr class=\""+rowStyle+"\"> <td>"+time+"</td> <td>"+rowData.InputDataName+"</td><td>"+rowData.procs.r+"</td><td>"+rowData.procs.b+"</td><td>"+rowData.memory.swpd+"</td><td>"+rowData.memory.buff+"</td><td>"+rowData.memory.cache+"</td><td>"+rowData.memory.free+"</td><td>"+rowData.swap.si+"</td><td>"+rowData.swap.so+"</td><td>"+rowData.io.bi+"</td><td>"+rowData.io.bo+"</td><td>"+rowData.system.in+"</td><td>"+rowData.system.cs+"</td><td>"+rowData.cpu.us+"</td><td>"+rowData.cpu.sy+"</td><td>"+rowData.cpu.id+"</td><td>"+rowData.cpu.wa+"</td> </tr>");
